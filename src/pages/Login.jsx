import { Box, FormControl, FormHelperText, FormLabel, Input, Container, Button, Heading, HStack } from '@chakra-ui/react';
...
export default function Login(){
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await fetch('https://tokpedplay.up.railway.app/api/login/', {
        method: 'POST',
        headers: {
    ...
    return(
      <Container marginTop="30px" marginBottom="30px" boxShadow="12px 12px" maxW="480px" border="4px" borderColor="green.500">
        <Form onSubmit={handleSubmit}>
            <Heading padding="30px 30px 0px 30px">Login</Heading>
            <FormControl isRequired p="30px 30px 5px 30px">
            ...
            <HStack>
              ...
              <Link to="/register"><u>Dont Have Account Yet? Register Now</u></Link>
            </HStack>
        </Form>
      </Container>
    )
